...
{
    public class PE1279 : BasePetEffect
    {
        ...
        public PE1279(int count, int probability, int type, int skillId, int delay, string elementID)
            : base(ePetEffectType.PE1279, elementID)
        {
            m_count = count;
            m_coldDown = count;
        ...
        {
            PE1279 effect = living.PetEffectList.GetOfType(ePetEffectType.PE1279) as PE1279;
            if (effect != null)
            {
