...
{
    public class CE1282 : BasePetEffect
    {
        ...
        public CE1282(int count, int probability, int type, int skillId, int delay, string elementID)
            : base(ePetEffectType.CE1282, elementID)
        {
            m_count = count;
            m_coldDown = count;
        ...
        {
            CE1282 effect = living.PetEffectList.GetOfType(ePetEffectType.CE1282) as CE1282;
            if (effect != null)
            {
        ...
        {
            int damageReduceAmount = damageAmount * 30 / 100;
