...
{
    public class FiveEpicThirdBoss : ABrain
    {
        ...
        private int m_npcId1 = 5422; //mo han

        private int m_npcId2 = 5423; // hop quai di

        private int m_npcId3 = 5424; // dai` cao

        private int m_npcEnemyId = 5404; // lao gia cho ma
