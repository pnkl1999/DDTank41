...
{
    public class PE1340 : BasePetEffect
    {
        ...
        public PE1340(int count, int probability, int type, int skillId, int delay, string elementID)
            : base(ePetEffectType.PE1340, elementID)
        {
            m_count = count;
            m_coldDown = count;
        ...
        {
            PE1340 effect = living.PetEffectList.GetOfType(ePetEffectType.PE1340) as PE1340;
            if (effect != null)
            {
