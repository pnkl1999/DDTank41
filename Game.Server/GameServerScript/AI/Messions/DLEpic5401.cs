...
{
    public class DLEpic5401 : AMissionControl
    {
        ...
        private int bossId = 5401; //quypuchi

        private int npcId1 = 5402; //nole

        private int npcId2 = 5403; //banh rang

        private int helperId = 5404; // nha tham hiem
