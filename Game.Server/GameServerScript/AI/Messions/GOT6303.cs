...
{
  public class GOT6303 : AMissionControl
  {
        ...
        private int bossID = 6331; // oai tu

        private int fanID = 6334; // fan

        private int arbitraID = 6332; // trong tai

        private int holegenID = 6335; // buc dung
