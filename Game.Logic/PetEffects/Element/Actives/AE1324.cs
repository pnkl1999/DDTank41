...
{
    public class AE1324 : BasePetEffect
    {
        ...
        public AE1324(int count, int probability, int type, int skillId, int delay, string elementID)
            : base(ePetEffectType.AE1324, elementID)
        {
            m_count = count;
            m_coldDown = count;
        ...
        {
            AE1324 effect = living.PetEffectList.GetOfType(ePetEffectType.AE1324) as AE1324;
            if (effect != null)
            {
