...
namespace Game.Server.GameServerScript.AI.NPC
{
    public class ThirteenSimpleAntBoss : ABrain
    {
        ...
        private int m_friendBoss = 13002;
        ...
        private void PersonAttack()
        {
            ...
            if (Body.ShootPoint(m_targer.X, m_targer.Y, 0, 30, 51, 1000, 10000, 1, 3.0f, 2800))
            {
        ...
        private void FrozenAttack()
        {
            ...
            {
                if (Body.ShootPoint(listAttack[0].X - 20, listAttack[0].Y, 0, 30, 99, 1000, 10000, 1, 3.0f, 3000))
                {
                ...
                {
                    if (Body.ShootPoint(listAttack[1].X - 20, listAttack[1].Y, 0, 30, 99, 1000, 10000, 1, 3.0f, 5000))
                    {
