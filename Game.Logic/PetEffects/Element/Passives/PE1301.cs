...
namespace Game.Logic.PetEffects.Element.Passives
{
    public class PE1301 : BasePetEffect
    {
        ...
        {
            PE1301 effect = living.PetEffectList.GetOfType(ePetEffectType.PE1301) as PE1301;
            if (effect != null)
            {
        ...
        public void player_beginNextTurn(Living living)
        {
            ...
            {   
                ...
                {
                    CE1301 effect = enemy.PetEffectList.GetOfType(ePetEffectType.CE1301) as CE1301;
                    if (effect == null)
                    {
                        enemy.AddPetEffect(new CE1301(0, m_probability, m_type, m_currentId, m_delay, ElementInfo.ID.ToString()), 0);
                    }
                }
                IsTrigger = true;
            }           
