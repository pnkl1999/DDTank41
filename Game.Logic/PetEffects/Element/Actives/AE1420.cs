...
{
    public class AE1420 : BasePetEffect
    {
        ...
        public AE1420(int count, int probability, int type, int skillId, int delay, string elementID)
            : base(ePetEffectType.E1420, elementID)
        {
            m_count = count;
            m_coldDown = count;
        ...
        {
            AE1420 effect = living.PetEffectList.GetOfType(ePetEffectType.E1420) as AE1420;
            if (effect != null)
            {
