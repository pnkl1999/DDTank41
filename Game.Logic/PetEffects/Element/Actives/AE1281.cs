...
namespace Game.Logic.PetEffects.Element.Actives
{
    public class AE1281 : BasePetEffect
    {
        ...
        {
            AE1281 effect = living.PetEffectList.GetOfType(ePetEffectType.AE1281) as AE1281;
            if (effect != null)
            {
        ...
        void player_AfterBuffSkillPetByLiving(Player player)
        {
            ...
            {
                player.AddPetEffect(new CE1281(2, m_probability, m_type, m_currentId, m_delay, ElementInfo.ID.ToString()), 0);
