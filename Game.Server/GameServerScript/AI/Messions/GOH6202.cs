...
{
  public class GOH6202 : AMissionControl
  {
        ...
        private int bossID = 6223;

        private int blueID = 6222;

        private int redID = 6221;

        private int homeID = 6224;

        private int heroID = 6214;
