...
{
    public class DLEpic5404 : AMissionControl
    {
        ...
        private int bossId = 5431;

        private int npcId = 5432;

        private int npcHelperId1 = 5433; // nha tham hiem

        private int npcHelperId2 = 5434; // pha le
