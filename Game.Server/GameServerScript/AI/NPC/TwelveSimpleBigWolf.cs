            ...
            if (dis > 97)
            {
                ...
                if (player.Y < 420 && player.X < 210)
                {
                    if (Body.Y > 420)
                    {
                        if (Body.X - dis < 50)
                        {
                            Body.MoveTo(25, Body.Y, "walk", 1200, "", (Body as SimpleNpc).NpcInfo.speed, new LivingCallBack(MoveBeat));
                        }
                        else
                        {
                            Body.MoveTo(Body.X - dis, Body.Y, "walk", 1200, "", (Body as SimpleNpc).NpcInfo.speed, new LivingCallBack(MoveBeat));
                        }
                    }
                    else
                    {
                ...
                else
                {
                    if (Body.Y < 420)
                    {
                        if (Body.X + dis > 200)
                        {
                            Body.MoveTo(200, Body.Y, "walk", 1200, "", (Body as SimpleNpc).NpcInfo.speed, new LivingCallBack(MoveBeat));
                        }
                    }
                    else
                    {
