...
namespace Game.Logic.PetEffects.Element.Actives
{
    public class AE : BasePetEffect
    {
        ...
        public AE(int count, int probability, int type, int skillId, int delay, string elementID)
        ...
        {
            AE effect = living.PetEffectList.GetOfType(ePetEffectType.AE) as AE;
            if (effect != null)
            {
