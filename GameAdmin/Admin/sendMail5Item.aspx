            ...
            function call_addItems(GoodIDs, count) {
                ...
                if (errors == 0) {
                    ...
                    $j.ajax({
                        ...
                        data: "{GoodIDs:" + GoodIDs + ",Keys:'0.0.0.0.0.0',isPopup:1}",
                    ...
                    <tr>
                        ...
                        <tr>
                            <td class="style1455">
                                ...
                                </select>&nbsp;&nbsp;&nbsp; <span class="style1486">
                                <br />
                                </span> <span class="auto-style1">Click&nbsp; &quot;</span><span 
                                    class="auto-style2">Tuỳ chọn</span><span class="auto-style1">&quot; để cường hoá, hợp 
                                thành, gia hạn .</span><span class="style1486"><br />
                                </span><span class="auto-style1">Cảnh báo tất cả các vật phẩm&nbsp; mặc định là <strong>vĩnh cửu</strong>.</span></td></tr>
                        <tr>
                            <td class="style1454">
