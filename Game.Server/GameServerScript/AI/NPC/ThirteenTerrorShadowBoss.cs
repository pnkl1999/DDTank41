...
namespace Game.Server.GameServerScript.AI.NPC
{
    public class ThirteenTerrorShadowBoss : ABrain
    {
        ...
        private int m_friendBoss = 13308;
        ...
        public override void OnBeginSelfTurn()
        {
            ...
            if (friendBoss == null)
            {
                ...
                if (npcs.Length > 0)
                    friendBoss = npcs[0];
                npcs = ((PVEGame)Game).FindLivingTurnBossWithID(m_friendBoss + 100);
                if (npcs.Length > 0)
                    friendBoss = npcs[0];
            }
        ...
        private void WishDead()
        {
            ...
            {
                // bomb in friend boss
                //friendBoss.Say("Hãy vĩnh biệt cuộc đời này đi lũ cờ hó.", 0, 1000);
                friendBoss.PlayMovie("beatC", 1000, 5000);
                friendBoss.CallFuction(DeadAllPlayers, 4500);
            }
        }
        ...
        private void DamageDeadLine()
        {
            ...
            Body.RangeAttacking(568, 10000, "cry", 2500, true);
        }
        ...
        {
            phyLineDead = (Game as PVEGame).Createlayer(1212, 1020, "", "asset.game.ten.tedabiaoji", "", 1, 0);
        }
